...
chk("camoufox binary present", _verify_camoufox)
...
chk("Telegram client initialises", _init_telegram)
chk("Telegram sends test message", _send_telegram_test)

# 4. Logging / Filesystem
print("\n[4/4] Logging / Filesystem")
chk("logs/ directory writable", _check_logs_dir)
